...
<head>
	...
	<link rel="stylesheet" href="css/styleImprove.css" />
	<!-- Кодировка страницы -->
	<meta charset="UTF-8">
		...
		<div class="wrapper">
			<div class="content">
				<div class="main">
					<div class="videoDiv">
						...
						<video muted autoplay loop class="main__video" id="main__video">
							<source src="videos/Improve.webm" type='video/webm; codecs="vp8, vorbis"'>
							<source src="videos/Improve.mp4" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'>
						</video>
					...
					<div class="container">			
						<div class="main__column">
							<div class="flex__row">
								<p><a class="p__main" href="/">Главная</a> <span class="span__main" style="opacity: 0.6">| Инвесторам и акционерам</span></p>
							</div>
							<div class="main__text">Устойчивое развитие</div>
							<div class="main__p"><p>ЕПК АСКЕЛЛА  привержена Целям устойчивого развития ООН и содействует решению важных экономических, социальных и экологических задач стран в интересах бизнеса и общества.</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="second__block">
					<div class='container'>
						<p class="title__p">Принципы ответственного инвестирования</p>
						<div class="grid__row">
							<div class="grid__column__left">
								<div class="grid__column">
									<p class="princip__p">Строгое соблюдение законодательства и добросовестная конкуренция</p>
									<p class="princip__p">Исключение коррупции и конфликта интересов</p>
									<p class="princip__p">Уважение прав человека и недопущение дискриминации</p>
									<p class="princip__p">Создание равных возможностей и достойных условий труда</p>
									<p class="princip__p">Системный вклад в социально-экономическое развитие стран и регионов присутствия</p>
									<p class="princip__p">Забота об экологии и климате</p>
									<p class="princip__p">Учет нефинансовых рисков в инвестировании и управлении активами</p>
									<p class="princip__p">Равноправный диалог с заинтересованными сторонами</p>
								</div>
				...
				<!-- <div class="third__block">
					<div class="container">
						<div class="grid__row">
							<p class="third__title">Индексы и рейтинги ESG</p>
							<p class="third__text">АФК «Система» учитывает в своей деятельности независимую оценку уровня корпоративного управления и прозрачности, социальной и экологической ответственности.</p>
						</div>
					</div>
				</div> -->
...
<script src="//translate.google.com/translate_a/element.js?cb=TranslateInit"></script>
		...
		<script type="text/javascript" src="js/improve.js"></script>
</body>
</html>