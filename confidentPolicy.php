			...
			<div class="content">
				<div class="container">
					<div class="flex__column mar">
						<div class="flex__row">
								<p><a class="p__main" href="/">Главная</a> <span class="span__main" style="opacity: 0.6">| Политика конфиденциальности</span></p>
						</div>
						<p class="main__title">Политика конфиденциальности</p>
						<p class="main__p">
