...
<html>
<head>
	<title>Новости Нурказпром</title>
			...
			<div class="content">
				<div class="container">
					<div class="first__block">
						<p class="p_first"><a class="p__main" href="../../main">Главная</a> |<a class="p__main" href="../../companies"> Активы </a><a class="p__main" href="../nurkazProm">| Нурказпром</a> <span class="span__main" style="opacity: 0.6">| О современных видах ремонта вагонов </span></p>
						<p class="main__title">О современных видах ремонта вагонов</p>
						<p class="main__text">Железная дорога – основа транспортной инфраструктуры страны. От исправности магистралей и самого транспорта зависит не только безопасность и удобство передвижения, но и состояние экономики. Чтобы грузовые вагоны могли безопасно перевозить груз, они регулярно проходят диагностику и ремонт. Какой вид работ будет проведен, зависит от состояния комплектующих. Иногда можно обойтись ремонтом деталей, а в некоторых случаях требуется полная замена узлов.Виды ремонта вагоновРемонт вагонов может быть аварийным или профилактическим. В любом случае проведенные мастерами манипуляции можно разделить на следующие виды:1. Деповский ремонт. В данном случае все манипуляции проделывают в депо. Сначала из вагона убирают остатки перевозимого груза и только после этого начинают проводить диагностические процедуры. После завершения работ специалист вместе с приемщиком составляют дефектную ведомость, в которой содержится полный перечень данных об обнаруженных поломках.2. Капитальный ремонт. В основном такому ремонту подвергаются вагоны, находящиеся в эксплуатации в течение длительного периода времени. При капитальном восстановлении проводится восстановление всех изношенных комплектующих. В тех случаях, когда речь идет о несъемных деталях, их ремонт осуществляют на месте. Капитальный ремонт всегда проводится в четком соответствии с определенным набором требований. Новые комплектующие должны соответствовать установленным нормам, иметь сертификаты и клейма. После завершения всех работ вагон возвращают в эксплуатацию.3. Текущий отцепочный ремонт. Такие манипуляции проводят на специальных путях. Вагон может быть пустым или груженным. При отцепочном ремонте изношенные элементы заменяют новыми аналогами.Часто при проведении ремонтных работ мастера используют пометки ТР-1 и ТР-2. Первый код применяется для обозначения ремонта вагонов при подготовке к отправке. А второй – к вагонам, которые отцепляют от прибывшего в разборку или транзитного состава.Как осуществляется приемка в ремонт?Приемка вагонов в ремонт осуществляется в строгом соответствии с нормами и требованиями, указанными в официальных документах. Установленных правил придерживаются все: и приемщики, и мастера, и другие специалисты, имеющие отношение к проведению ремонтных работ.Больше информации об условиях и стоимости сотрудничества со специалистами можно получить у представителя ремонтной компании.
</p>
