			...
			<div class="content">
				<div class="container">
					<div class="first__block">
						<p class="p_first"><a class="p__main" href="../../main">Главная</a> |<a class="p__main" href="../../companies"> Активы </a><a class="p__main" href="../askellaInvest">| Askella Invest</a> <span class="span__main" style="opacity: 0.6">| >Крупнейшие порты мира - Сингапур.....</span></p>
...
В Сингапуре находятся одни из самых больших нефтеперерабатывающих заводов, буксирное судно сопровождает танкер, отправляющийся на нефтяной терминал. Если что-то пойдет не так, то будет перекрыто все движение.<br>
...
Хорошая пришвартовка - всегда большое облегчение, потому что в прошлом не все было хорошо: в октябре 1997 г 2 танкера WLCC столкнулись, было 6 предупреждений, у них было 10 минут.<br>
