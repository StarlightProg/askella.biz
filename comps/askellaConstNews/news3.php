...
<html>
<head>
	<title>Новости ASKELLA CONSTRUCTION</title>
			...
			<div class="content">
				<div class="container">
					<div class="first__block">
						<p class="p_first"><a class="p__main" href="../../main">Главная</a> |<a class="p__main" href="../../companies"> Активы </a><a class="p__main" href="../askellaConst">| ASKELLA CONSTRUCTION</a> <span class="span__main" style="opacity: 0.6">| Сингапур и Роттердам подписали соглашение о создании.....</span></p>
						<p class="main__title">Сингапур и Роттердам подписали соглашение о создании самого длинного в мире зеленого судоходного коридора</p>
						<p class="main__text">Морское и портовое управление Сингапура (MPA) и Администрация порта Роттердам, 2х крупнейших бункеровочных портов в мире, подписали Меморандум о взаимопонимании (МоВ) о создании самого длинного в мире зеленого коридора для судоходства.Подробности МоВ:<br>
начало зеленого судоходства - к 2027 г.;<br>
предполагается объединить широкую коалицию грузоотправителей, поставщиков топлива и других компаний для совместной работы;<br>
предполагается переходу на низкоуглеродную альтернативу топлива, включая синтетический метан, водород и топливо на основе водорода, включая аммиак и метанол;<br>
будут работы по оптимизации эффективности морских перевозок, безопасности и прозрачности потока товаров путем создания цифрового торгового коридора, где обмениваются соответствующими данными, электронной документацией и стандартами. Это облегчит беспрепятственное движение судов и грузов и оптимизирует своевременное прибытие судов из порта в порт;<br>
портовые власти будут сотрудничать:<br>
с Глобальным центром по декарбонизации морских перевозок и Центром Mærsk Mc-Kinney Møller по доставке с 0м выбросом углерода,<br>
с другими отраслевыми партнерами по всей цепочке поставок, включая BP, CMA CGM, Ассоциацию цифровых контейнерных перевозок, Maersk, MSC, Ocean Network Express (ONE), PSA Internationalи Shell для начала.<br>
Популярность зеленых коридоров растет как средства, помогающего судоходству снизить углеродный след.Коридоры предполагают создание конкретных торговых маршрутов между крупными портовыми узлами, где демонстрируются и поддерживаются решения с 0м уровнем выбросов.Во время климатического саммита COP26 ООН в г. Глазго в 2021 г. коалиция стран приняла Декларацию Клайдбанка, согласившись создать по меньшей мере 6 зеленых коридоров к 2025 г.Ранее в 2022 г. порты Лос-Анджелеса и Шанхая объявили о партнерстве с Зеленым судоходным коридором, поставив цели:<br>
поэтапный ввод судов с низким, сверхнизким и 0м выбросом углерода в течение 2020х гг.;<br>
планирование первых в мире транстихоокеанских контейнерных перевозок с 0м выбросом углерода к 2030 г.<br>
Международная морская организация ООН (ИМО) разработала первоначальную стратегию по сокращению общих выбросов парниковых газов от судоходства на 50% от уровня 2008 г. к 2050 г., но агентство находится под растущим давлением, требующим принятия более амбициозной цели в соответствии с Парижским соглашением об изменении климата 2015 г., то есть чистого 0 к 2050 г.Нынешний МоВ укладывается в стратегию Сингапура переходу на многотопливную бункеровку в рамках Плана декарбонизации морского транспорта Сингапура до 2050 г.<br>
