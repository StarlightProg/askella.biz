			...
			<div class="content">
				<div class="container">
					<div class="first__block">
						<p class="p_first"><a class="p__main" href="../../main">Главная</a> |<a class="p__main" href="../../companies"> Активы </a><a class="p__main" href="../mirSumok">| Мир сумок</a> <span class="span__main" style="opacity: 0.6">| Вопросы, на которые следует ответить при......</span></p>
						<p class="main__title">Вопросы, на которые следует ответить при выборе рюкзака.</p>
						<p class="main__text">Вопросы, на которые следует ответить при выборе рюкзака.<br>
Сколько отделений в рюкзаке мне необходимо?<br>
Какой каркас удобнее для меня? <br>
Твердый/Мягкий?<br>
Какого цвета мне не хватает в гардеробе?<br>
Что из моих вещей самое габаритное? (Иногда идея «взять самый большой рюкзак, чтобы влезло все» - это заблуждение, а для повседневного набора вещей подойдет рюкзак средних габаритов)
Ответив на эти вопросы, вам будет легче выбрать тот самый рюкзак для себя.
